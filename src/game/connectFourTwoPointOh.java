...
public class connectFourTwoPointOh extends javax.swing.JFrame {

    /**
     * Creates new form connectFour
     */
    public connectFourTwoPointOh(connector b, boolean bool) {
        player = bool;
        board = b;
        initComponents();
        setResizable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        int boardResult = board.dropZero(player);
        if (boardResult == 1) {
            connect2Win w = new connect2Win();
            setVisible(false);
        } else if (boardResult == 2) {
            connect2Lose l = new connect2Lose();
            setVisible(false);
            ...
            connectFourTwoPointOh c = new connectFourTwoPointOh(board, player);
            setVisible(false);
        } else if (boardResult == -1) {
        }
    }
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        int boardResult = board.dropOne(player);
        if (boardResult == 1) {
            connect2Win w = new connect2Win();
            setVisible(false);
        } else if (boardResult == 2) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        int boardResult = board.dropTwo(player);
        if (boardResult == 1) {
            connect2Win w = new connect2Win();
            setVisible(false);
        } else if (boardResult == 2) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        int boardResult = board.dropThree(player);
        if (boardResult == 1) {
            connect2Win w = new connect2Win();
            setVisible(false);
        } else if (boardResult == 2) {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        int boardResult = board.dropFour(player);
        if (boardResult == 1) {
            connect2Win w = new connect2Win();
            setVisible(false);
        } else if (boardResult == 2) {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        int boardResult = board.dropFive(player);
        if (boardResult == 1) {
            connect2Win w = new connect2Win();
            setVisible(false);
        } else if (boardResult == 2) {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        int boardResult = board.dropSix(player);
        if (boardResult == 1) {
            connect2Win w = new connect2Win();
            setVisible(false);
        } else if (boardResult == 2) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(connectFourTwoPointOh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new connectFourTwoPointOh(board,player).setVisible(true);
            }
        });
    }
